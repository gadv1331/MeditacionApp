...
class vistaAnsiedadAudio7min: UIViewController,AVAudioPlayerDelegate {
    ...
    func playAudio() {
            guard let audioURL = Bundle.main.url(forResource: "AnsiedadVideo2", withExtension: "mp3") else {
