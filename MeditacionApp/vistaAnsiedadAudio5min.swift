...
class vistaAnsiedadAudio5min: UIViewController,AVAudioPlayerDelegate{
    ...
    func playAudio() {
            guard let audioURL = Bundle.main.url(forResource: "AnsiedadVideo1", withExtension: "mp3") else {
