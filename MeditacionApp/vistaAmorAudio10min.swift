...
class vistaAmorAudio10min: UIViewController,AVAudioPlayerDelegate{
    ...
    func playAudio() {
            guard let audioURL = Bundle.main.url(forResource: "AmorPropioVideo2", withExtension: "mp3") else {
